...
static void InitDefaultsscc_info_RpcHeader_rpcheader_2eproto() {
  ...
  {
    void* ptr = &::toy_rpc::_RpcHeader_default_instance_;
    new (ptr) ::toy_rpc::RpcHeader();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::toy_rpc::RpcHeader::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::toy_rpc::RpcHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::toy_rpc::RpcHeader, service_name_),
  PROTOBUF_FIELD_OFFSET(::toy_rpc::RpcHeader, method_name_),
  PROTOBUF_FIELD_OFFSET(::toy_rpc::RpcHeader, args_size_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::toy_rpc::RpcHeader)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::toy_rpc::_RpcHeader_default_instance_),
};

const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\007toy_rpc\"I\n\tRpcHeader\022"
...
RpcHeader::RpcHeader()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:toy_rpc.RpcHeader)
}
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  // @@protoc_insertion_point(copy_constructor:toy_rpc.RpcHeader)
}
...
RpcHeader::~RpcHeader() {
  // @@protoc_insertion_point(destructor:toy_rpc.RpcHeader)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:toy_rpc.RpcHeader)
...
::PROTOBUF_NAMESPACE_ID::uint8* RpcHeader::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:toy_rpc.RpcHeader)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:toy_rpc.RpcHeader)
  return target;
}

size_t RpcHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:toy_rpc.RpcHeader)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:toy_rpc.RpcHeader)
  GOOGLE_DCHECK_NE(&from, this);
  const RpcHeader* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RpcHeader>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:toy_rpc.RpcHeader)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:toy_rpc.RpcHeader)
    MergeFrom(*source);
  }
}

void RpcHeader::MergeFrom(const RpcHeader& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:toy_rpc.RpcHeader)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:toy_rpc.RpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:toy_rpc.RpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::toy_rpc::RpcHeader* Arena::CreateMaybeMessage< ::toy_rpc::RpcHeader >(Arena* arena) {
  return Arena::CreateInternal< ::toy_rpc::RpcHeader >(arena);
}
